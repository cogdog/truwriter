...
<p>Now that you’ve installed TRU Writer and can see the barebones theme staring back at you. It is not very interesting. Yet. Get rid of any “Hello World” posts, say good bye. Set your TRU Theme Options (see below). Set up a menu. Try using the Write page to create some initial content.</p>
...
<h3 id="set-out-your-menus">Set Out Your Menus</h3>
...
<p>Only one special page is needed now (there was at one time four!)</p>
...
<h2 id="customize-the-writing-form-prompts">Customize the Writing Form Prompts</h2>
<p>You can customize the field labels and the descriptions of the form where people submit new pieces of writing to a TRU Writer site. On your site navigate to the writer form, and activate the Wordpress Customizer from the admin bar.</p>
...
<p>Then from this pane, open “Writing Form Prompts” tab</p>
...
<h2 id="customize-the-form-and-button-colors">Customize the Form and Button Colors</h2>
<p>On your site navigate to the writer form, and activate the Wordpress Customizer from the admin bar.</p>
<p>In the Customizer, under TRU Writer, look for a pane for <strong>Form and Button Colors</strong>:</p>
<p><img src="<?php echo get_stylesheet_directory_uri()?>/"images/colors-customizer.jpg" /></p>
<p>Use these settings to change the colors of the two buttons used on the Writing Form (one to update/submit drafts, the other for the final submission. There are also controls to modify the background colors on the form- for a new entry, for one that hs in draft, and a warning for form errors.</p>
<p>Finally, you can modify the roundness of buttons. Why? Because we can</p>
<h2 id="customize-the-published-layout">Customize the Published Layout</h2>
<p>You can also customize the content layout. On your site navigate to any content post or page, and activate the Wordpress Customizer from the admin bar. From the <strong>TRU Writer</strong> pane, open <strong>Published Layout</strong>.</p>
<p>Here you can choose from the Thin or Medium layout widths (Wide will only affect very large screens).</p>
<p><img src="<?php echo get_stylesheet_directory_uri()?>/"images/customizer-layout.jpg" /></p>
<p>A small thing, but a corny heading of “SO IT WAS WRITTEN” was hardwired into the single post template; this is now something that can be changed in the Customizer:</p>
