...
To get the TRU Writer active on your site all you need to do is activate the "TRU Writer" theme when it appears in the Wordpress dashboard under **Appearance** --> **Themes**.  Now you can move on to learn about setting it up in the [TRU Writer Documentation](https://github.com/cogdog/truwriter/docs.md).
